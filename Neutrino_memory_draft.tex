...
It has a longitudinal component in addition to the transverse component in the usual gravitational memory (Christodolou effect). 
...
Throughout this calculation we assume that the interferometer is very far from the supernova and the interferometers' arm length is much smaller then the distance to the supernova. Thus we assume there are three small quantities, $\frac{M}{r_0}, \frac{\delta M}{r_0}, \frac{d}{r_0}<<1$. To simplify notation we will use the symbol $\mathcal{O}(r^{-1}_{0})$ to represent suppression by any one of the three small quantities. 
...
%
%To leading order $r_B(t + t_1) - r_A(t) = d$ therefore $ - \frac{M(r_B(t + t_1) - r_A(t)}{r_0^2}$ becomes $ - \frac{Md}{r_0^2}$ to $\mathcal{O}(r_0^{-2})$
%
%\begin{equation}
%	t_1 = (r_B(t + t_1) - r_A(t)) \left( 1 + \frac{2M}{r_0} + \frac{4M^2 - M d}{r_0^2} \right)
%\end{equation}
%
%Next we evaluate the first bracket explicitly to 
