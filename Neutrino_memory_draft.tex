...
As shown in Fig.\ref{fig:3}, such response is actually about the proper time in one end when a signal bounces back.
...
Therefore we will simply calculate such proper length.
...
\footnote{Since the only thing the point does in the initial metric is accelerating, $\bar{t}_c$ will always multiply an acceleration term. 
