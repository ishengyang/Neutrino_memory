...
It is a simple trigonometry to show that they acquire a velocity toward each other right after shell crossing.
\begin{equation}
...
{\bf XXX Move everything below to the appendix, merge with the existing relevant section there.}
...
{\bf XXX after you move everything above to the appendix, I will probably merge this to the previous section.}
